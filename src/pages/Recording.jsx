...
export default function ReactRecorder() {
  ...
  const sentencesByLanguage = {
    ...
    mixed_punjabi: [
      ...
      "9. ਮੈਨੂੰ ਆਪਣੀ online banking use ਕਰਨ ਵਿੱਚ problem ਆ ਰਹੀ ਹੈ। ਕੀ ਤੁਸੀਂ ਮੇਰੀ assist ਕਰ ਸਕਦੇ ਹੋ?",
      ...
      "17. ਕਿਰਪਾ ਕਰਕੇ ਆਪਣੀ identification ਅਤੇ address proof ਪ੍ਰਦਾਨ ਕਰੋ?",
